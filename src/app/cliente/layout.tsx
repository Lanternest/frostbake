...
const navItems = [
    { href: "/cliente", label: "Datos personales", icono: "👤" },
    { href: "/cliente/pedidos", label: "Historial de pedidos", icono: "🛒" },
    { href: "/cliente/promociones", label: "Promociones", icono: "🎉" },
]
...
export default function ClienteLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const verificar = async () => {
            ...
            if (perfil?.rol !== "cliente") router.push("/")
        }
        verificar()
    }, [])
        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-200 fixed h-full">
                <div className="p-6 border-b border-gray-100">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Panel cliente</p>
                </div>
                ...
                <div className="p-4 border-t border-gray-100">
                    <Link
                        href="/productos"
                        className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors mb-1"
                    >
